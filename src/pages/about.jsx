...
function about() {
  return (
    <>
      ...
      <section>
        <div className="card" style={{ "width": "20rem", marginTop: '30px', marginBottom: '30px', }}>
          <img src="https://mdbootstrap.com/img/new/standard/nature/182.jpg" className="card-img-top" alt="..." />
          <div className="card-body">
            <p className="card-text">
              Some quick example text to build on the card title and make up the bulk of the
              card's content.
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero veniam similique voluptas optio sit officiis dolorem odio, repellendus neque iste inventore? Delectus labore minima facere beatae cumque tempora, magni nam.
            </p>
          </div>
        </div>
