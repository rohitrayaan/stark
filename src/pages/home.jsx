...
import Iron from "../images/iron2.jpg"
import Iron2 from "../images/iron.jpg"
import Iron3 from "../images/iron3.jpg"
                ...
                <div id="carouselBasicExample" className="carousel slide carousel-fade" data-mdb-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item active">
                            <img src={Iron2} className="d-block w-100" alt="..." />
                        ...
                        <div className="carousel-item">
                            <img src={Iron3} className="d-block w-100" alt="..." />
                            <div className="carousel-caption d-none d-md-block">
                        ...
                        {/* Single item */}
                        <div className="carousel-item">
                            <img src={Iron} className="d-block w-100" alt="..." />
                            <div className="carousel-caption d-none d-md-block">
